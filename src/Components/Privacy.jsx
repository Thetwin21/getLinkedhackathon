...
<span class="star1"></span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 max-w-[600px] md:p-12 md:max-w-[1020px] lg:max-w-[3000px] w-full ">
        <div className="gap-y-5">
          <h3 data-aos="fade-right" className="text-2xl text-center md:text-start font-semibold text-[#fff]">
            Privacy Policy and
          </h3>
          <h3 data-aos="fade-right" className="text-2xl text-center md:text-start text-pink font-semibold ">Terms</h3>
          <p data-aos="fade-right" className=" mb-10 text-[#fff] text-center md:text-start text-base">
            <small>Last updated on September 12, 2023</small>
          </p>
          <p data-aos="fade-right" className="text-[#fff] text-center md:text-start text-base">
            Below are our privacy & policy, which outline a lot of goodies. it’s
            our aim to always take of our participant
          </p>
          <div className="my-16 p-8 border-solid border-[1px] border-[#D434FE] rounded-[5px]  space-y-5 relative z-10">
            <p data-aos="fade-right" className="text-[#fff] text-sm text-center md:text-start">
            ...
            <div>
              <h4 data-aos="fade-right" className="text-lg text-pink font-semibold">
                Licensing Policy
              </h4>
              <p data-aos="fade-right" className="text-[#fff] text-base">
                Here are terms of our Standard License:
              </p>
              <div className="my-5 space-y-4">
                <div data-aos="fade-right" className="flex gap-2 items-start">
